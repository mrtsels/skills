...
| [claude-academic-workflow-guide](./../../academic/claude-academic-workflow-guide/SKILL.md) | Claude Code template for LaTeX, Beamer, and R research workflows |
...
| [paper-to-agent-guide](./../../academic/paper-to-agent-guide/SKILL.md) | Transform research papers into interactive AI agents for exploration |
| [rd-agent-guide](./rd-agent-guide/SKILL.md) | Microsoft AI-driven R&D agent for automated data and model development |
| [research-workflow-automation](./../../workflow/research-workflow-automation/SKILL.md) | Automate repetitive research tasks with pipelines, schedulers, and scripting |
