...
| Skill | Description |
|-------|-------------|
| [anystyle-api](./../../research/anystyle-api/SKILL.md) | Citation reference parser using machine learning |
...
| [paper-reading-workflow](./../../paper/paper-reading-workflow/SKILL.md) | Deep dual-mode reading of academic papers from PDF or URL sources |
...
| [zotero-style-guide](./../../note-taking/zotero-style-guide/SKILL.md) | Feature-rich Zotero plugin for UI customization and styling |
