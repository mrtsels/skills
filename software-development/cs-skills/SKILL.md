...
| Skill | Description |
|-------|-------------|
| [ai-security-papers-guide](./../../research/ai-security-papers-guide/SKILL.md) | AI security papers from top-4 security conferences |
...
| [code-llm-papers-guide](./../../research/code-llm-papers-guide/SKILL.md) | Survey and paper collection on LLMs for code generation |
...
| [gaussian-splatting-papers-guide](./../../research/gaussian-splatting-papers-guide/SKILL.md) | Curated papers and resources for 3D Gaussian Splatting |
| [llm-aiops-guide](./../../research/llm-aiops-guide/SKILL.md) | Papers on LLMs for IT operations and AIOps research |
